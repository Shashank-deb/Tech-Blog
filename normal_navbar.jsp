  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
       ...
       <li class="nav-item active">
        <a target="false" class="nav-link" href="login_page.jsp"><span class="fa fa-user-circle fa-spin"></span>Login </a>
      </li>
       <li class="nav-item active">
        <a target="false" class="nav-link" href="registred_page.jsp"><span class="fa fa-user-plus "></span>Sign Up</a>
      </li>
